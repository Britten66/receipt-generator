...
function Terms() {
  return (
    <>
      ...
      <p style={{ marginTop: 6 }}><strong>Voice processing:</strong> Your audio is transmitted to Groq for transcription using Groq's Whisper model. The transcript is then processed by Groq's language model to extract invoice fields. Invoice Prepper does not store your audio recordings.</p>
...
function Privacy() {
  return (
    <>
      ...
      <p style={{ marginTop: 6 }}><strong>AI data (Voice AI plan only):</strong> when you use the voice or text AI parser, your input is transmitted to Groq, Inc. for processing. We do not store audio recordings. We store only a daily usage count per account for rate-limiting purposes. Your stored invoices and historical data are never sent to Groq.</p>
