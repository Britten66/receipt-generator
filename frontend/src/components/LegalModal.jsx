...
function Terms() {
  return (
    <>
      ...
      <p style={{ marginTop: 6 }}><strong>Data scope:</strong> Only content you actively submit for parsing is sent to Groq. Your stored invoices, historical records, and account credentials are never sent to Groq. Your past invoice history (client names and service prices) is used within the app solely to personalise AI suggestions for your account — this processing happens on our servers and your historical data is never shared with Groq or any third party.</p>
...
function Privacy() {
  return (
    <>
      ...
      <p>We use your data solely to provide the Service: storing your invoices, sending transactional emails (password resets, billing confirmations), and on Pro and Voice AI plans, sending invoices to your clients on your behalf. On the Voice AI plan, your past invoice history (client names and typical service prices) is used within the app to personalise AI parsing results for your account. This data is never shared externally and is used only to improve the accuracy of AI features for you specifically. We do not use your data for advertising, behavioural profiling, or any purpose beyond operating the Service.</p>
