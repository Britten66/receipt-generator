...
- Name: accessibility.spec.js >> Accessibility: WCAG + best practice >> sign up modal has no violations
- Location: src/__tests__/e2e/accessibility.spec.js:78:3
...
- generic [ref=e2]:
  ...
  - dialog "Create your account" [ref=e372]:
    - button "← Back" [ref=e373] [cursor=pointer]
    - generic [ref=e374]: InvoicePrepper
    - generic [ref=e375]: Create your account
    - generic [ref=e376]:
      - button "Sign Up" [ref=e377] [cursor=pointer]
      - button "Sign In" [ref=e378] [cursor=pointer]
    - button "Continue with Google" [ref=e379] [cursor=pointer]:
      - img [ref=e380]
    ...
    - generic [ref=e387]:
      ...
      - generic [ref=e388]:
        ...
        - textbox "Email" [active] [ref=e390]:
          - /placeholder: you@example.com
      - generic [ref=e391]:
        - generic [ref=e392]: Password
        - textbox "Password" [ref=e393]:
          - /placeholder: ••••••••
      - generic [ref=e394]:
        - generic [ref=e395]: Confirm Password
        - textbox "Confirm Password" [ref=e396]:
          - /placeholder: ••••••••
      - generic [ref=e397]:
        - generic [ref=e398]: Referral code (optional)
        - textbox "Referral code (optional)" [ref=e399]:
          - /placeholder: ABC23XYZ
      - button "Create Account" [ref=e400] [cursor=pointer]
```
